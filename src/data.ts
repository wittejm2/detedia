const data = [
  ...
  { puzzleNumber: 624,words:  ["cafes", "block", "occur", "tonic", "topic", "toxic"]},
  { puzzleNumber: 623,words:  ["plant", "trine", "trend"]},
  { puzzleNumber: 622,words:  ["crook", "blame", "pains", "assay", "squad", "squat"]},
  ...
  { puzzleNumber: 611,words:  ["tarry", "error", "refer", "rider", "river", "riser", "riper"]},
  { puzzleNumber: 610,words:  ["whole", "bunny", "puffy", "sucky", "dummy", "ruddy"]},
  { puzzleNumber: 609,words:  ["tacos", "shone", "moose", "gloss", "dross", "kiosk"]},
  ...
  { puzzleNumber: 601,words:  ["tired", "deeps", "death", "delve", "defog", "debug"]},
  { puzzleNumber: 600,words:  ["tango", "place", "deads", "ready", "beady", "heady"]},
  ...
  { puzzleNumber: 594,words:  ["scour", "whump", "guide", "unity", "until", "unlit"]},
  { puzzleNumber: 593,words:  ["under", "chill", "smoky", "gassy", "pasty", "tasty"]},
  ...
  { puzzleNumber: 586,words:  ["jazzy", "gurdy", "whiny", "peppy", "felty", "beefy"]},
  ...
  { puzzleNumber: 555,words:  ["poops", "frack", "delve", "midge", "nudge", "budge", "judge"]},
  { puzzleNumber: 554,words:  ["groom", "chart", "intra", "sutra", "tetra", "extra"]},
  { puzzleNumber: 553,words:  ["power", "podge", "posse", "poise"]},
  { puzzleNumber: 552,words:  ["gouge", "dorky", "coral", "forma", "sorta", "porta", "iorta"]},
  ...
  { puzzleNumber: 545,words:  ["focus", "avoid", "growl", "tromp", "prone", "probe"]},
  ...
  { puzzleNumber: 529,words:  ["trash", "stoop", "stuck", "stung", "stuff", "studs", "study"]},
  ...
  { puzzleNumber: 500,words:  ["onion", "night", "pinch", "pined", "pines", "piney"]},
  ...
  { puzzleNumber: 494,words:  ["grief", "folds", "flown", "flock", "float", "flout"]},
  ...
  { puzzleNumber: 487,words:  ["allay", "tooth", "verve", "rigid", "primp", "quirk"]},
